...
describe('MembersPanel', () => {
  it('lets an owner invite people and manage pending invitations and members', async () => {
    ...
    expect(screen.getAllByRole('listitem').some((item) => item.textContent?.includes('ana@example.test'))).toBe(true);
    expect(screen.getAllByRole('listitem').some((item) => item.textContent?.includes('bea@example.test'))).toBe(true);
