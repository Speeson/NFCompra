...
- Hito 3B (integración): las regresiones cubren iniciar con datos cacheados de Room, ordenar dos operaciones offline en una única sincronización y resolver un conflicto de versión de forma explícita.
