...
- La PWA autenticada usa una cabecera responsive con marca NFCompra, navegacion principal, notificaciones, menu de perfil accesible y un control de descarga de APK conectado al ultimo APK publicado en GitHub Releases.
