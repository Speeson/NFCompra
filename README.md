...
- Android ofrece las pantallas de autenticacion y conserva los tokens de sesion y renovacion mediante Android Keystore. El registro Android recoge nombre, apellidos, fecha de nacimiento, username, email, password y confirmacion de password, y envia el mismo contrato que la PWA. La pantalla autenticada incluye un banner superior comun con degradado verde, titulo centrado, campana superior con panel desplegable de notificaciones y flecha de vuelta en pantallas secundarias, navbar inferior flotante de Inicio, Hogares, Listas, Catalogo y Perfil, pantalla de Catalogo con categorias en tarjetas visuales, resumen de hogares/listas, seleccion de hogares aunque no tengan listas, creacion manual de la primera lista, renombrado, vaciado de comprados, eliminacion de listas y gestion de productos, con estados de carga, error y datos, y reintento ante conflictos.
