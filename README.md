...
- Android separa Inicio de la gestion de una lista concreta: Inicio muestra saludo, acciones rapidas, metricas, hogares y listas recientes, sin controles de renombrar, vaciar, eliminar ni editor de productos. La pestana Listas muestra el resumen de listas guardadas, coloca crear lista como accion principal a ancho completo, agrupa las listas por hogar y las presenta en tarjetas tipo catalogo con resumen de pendientes, comprados y total cuando esa lista esta cargada; crear lista abre un dialogo con selector de hogar y nombre. Al abrir una lista, Android navega a una pantalla independiente cuyo banner muestra el nombre editable de la lista y debajo el hogar. La cabecera interna queda compacta, con eliminar, vaciar rectangular, selector unico lista/cuadricula y alta de producto con cantidad; debajo aparecen secciones visuales separadas para Pendientes y Comprados con tarjetas y colores coherentes con la PWA. El dialogo de edicion de producto usa borde amarillo o rojo segun el estado del producto y permite editar nombre y cantidad. La busqueda de producto replica la PWA: usa snapshot de catalogo en memoria con fallback de busqueda remota, modo lista con sugerencias, modo tarjetas con cantidad inicial cero, tarjetas no seleccionables hasta elegir cantidad, iconos genericos, animacion visual de anadido, waitlist con boton de confirmacion y eliminacion previa por boton o gesto de deslizar.
